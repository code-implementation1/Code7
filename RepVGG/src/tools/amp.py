...
# ============================================================================
"""AMP optimization functional."""
import mindspore.nn as nn
from mindspore import dtype as mstype
from mindspore.ops import functional as mind_f
...
class OutputTo16(nn.Cell):
    ...
    def construct(self, x):
        return mind_f.cast(self._op(x), mstype.float16)
...
def cast_amp(net, args):
    ...
    if args.amp_level == 'O3':
        ...
        print(
            f'=> When amp_level is O0, using fixed loss_scale with '
            f'{args.loss_scale}'
        )
